...
<head>
  ...
  <title>Booking Service | Dashboard</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>asset/star-rating.min.js">
  <link rel="stylesheet" href="<?php echo base_url();?>asset/star-rating.min.css">
  <!-- jvectormap -->
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>asset/plugins/bootstrap-slider/slider.css">
  <!-- Daterange picker -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>B</b>KG</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b></b> Booking</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <li><a href="<?php echo base_url()?>ControllerUtama"><i class="fa fa-circle-o"></i> Home</a></li>
            <?php if (isset($_SESSION['level']) && $_SESSION['level'] == 'Admin') { ?>
              
           
              <li><a href="<?php echo base_url()?>KelolaAdmin"><i class="fa fa-circle-o"></i> Kelola Data Admin</a></li>
              <li><a href="<?php echo base_url()?>KelolaAcc"><i class="fa fa-circle-o"></i> Kelola Data Aksesoris</a></li>
              <li><a href="<?php echo base_url()?>KelolaMekanik"><i class="fa fa-circle-o"></i> Kelola Data Mekanik</a></li>
               <li><a href="<?php echo base_url()?>KelolaService"><i class="fa fa-circle-o"></i> Kelola Data P Service</a></li>
               <li><a href="<?php echo base_url()?>BookingAdmin"><i class="fa fa-circle-o"></i> <small class="label pull-right bg-blue notif_b"></small> Daftar Booking Pelanggan</a></li>
               <li><a href="<?php echo base_url()?>ChatRoom"><i class="fa fa-circle-o"></i> <small class="label pull-right bg-blue notif_p"></small>Chat Room</a></li>
                <!-- <li><a href="<?php echo base_url()?>DataMember"><i class="fa fa-circle-o"></i> Kelola Data Member</a></li> -->
                <li><a href="<?php echo base_url()?>ControllerRating/rating_admin"><i class="fa fa-circle-o"></i> Rating</a></li>
               ...
               <?php }elseif (isset($_SESSION['level']) && $_SESSION['level'] == 'Member') { ?>
             
             <li><a href="<?php echo base_url()?>DataMember"><i class="fa fa-circle-o"></i> Kelola Data Member</a></li>
              <li><a href="<?php echo base_url()?>Booking"><i class="fa fa-circle-o"></i> Booking Service</a></li>
               <li><a href="<?php echo base_url()?>ChatRoomUser"><i class="fa fa-circle-o"></i> Chat Room</a></li>
             <li><a href="<?php echo base_url()?>Rating"><i class="fa fa-circle-o"></i> Berikan Penilaian Anda</a></li>
            <li><a href="<?php echo base_url()?>ControllerLoginP/logout_m"><i class="fa fa-circle-o"></i> Logout</a></li> 
             <?php  } ?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php
        ...
        //echo "30 hari " . strtotime("+30 days");
        //$dt = new DateTime("@$hasil");  // convert UNIX timestamp to PHP DateTime
        //echo $dt->format('H:i A'); // output = 2017-01-01 00:00:00
      ?>
...
?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018</strong> | Bagus. All rights
    reserved.
  </footer>
...
<script src="<?php echo base_url();?>asset/plugins/bootstrap-slider/bootstrap-slider.js"></script>
<script>
  $(function () {
    /* BOOTSTRAP SLIDER */
    $('.slider').slider()
...
<script type="text/javascript">
  var get = function() {
    $.ajax({
        type : 'POST',
        url : '<?php echo base_url();?>ControllerEmail/notif',
        success : function(data){
            // $('.voters').html(data);
            // alert(data);
            var refInterval = window.setTimeout('get()', 1000); // 30 seconds
        },
    });
};
...
var getp = function() {
    $.ajax({
        type : 'POST',
        url : '<?php echo base_url();?>ControllerChat/notif',
        dataType:"json",
        success : function(data){
            $('.notif_p').html(data.notification);
            // alert(data.notification);
            var refInterval = window.setTimeout('getp)', 1000); // 30 seconds
        },
    });
};
...
var getn = function() {
    $.ajax({
        type : 'POST',
        url : '<?php echo base_url();?>ControllerBooking/notif_hapus',
        dataType:"json",
        success : function(data){
            $('.notif_dp').html(data.id_booking);
            // alert(data.notification);
            //window.location.href = "?param=" + encodeURI(data.id_booking);
            var refInterval = window.setTimeout('getn()', 1000); // 30 seconds
        },
    });
};
...
var getk = function() {
    $.ajax({
        type : 'POST',
        url : '<?php echo base_url();?>ControllerBooking/notif_booking',
        dataType:"json",
        success : function(data){
            $('.notif_b').html(data.notification);
            // alert(data.notification);
            var refInterval = window.setTimeout('getk)', 1000); // 30 seconds
        },
    });
};
