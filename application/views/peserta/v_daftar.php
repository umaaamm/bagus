...
<!-- </div> -->
    <div class="login-box-body">
        ...
        -->
        <form action="<?php echo base_url()?>SimpanMember" method="post">
            ...
            <div class="form-group">
              ...
              <div class="form-group has-feedback">
                <input type="text" class="form-control" name="merk_motor" placeholder="Merk Motor" required>
                <span class="fa fa-motorcycle form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="text" class="form-control" name="type_motor" placeholder="Type Motor" required>
                <span class="fa fa-motorcycle form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="text" class="form-control" name="plat_motor" placeholder="Plat Motor" required>
                <span class="fa fa-motorcycle form-control-feedback"></span>
            </div>
 <div class="form-group has-feedback">
