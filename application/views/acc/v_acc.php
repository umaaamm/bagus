						...
						<div class="col-md-4">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Kelola Data Aksesoris</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form role="form" action="<?php echo base_url()?>SimpanAcc" method="post">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_acc" placeholder="Nama" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Harga Aksesoris</label>
                                            <input type="text" class="form-control" name="harga_acc" placeholder="Harga" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Jenis</label>
                                ...
                                <div class="box-body">
                                    <table id="Admin" class="table table-bordered table-striped">
                                         <thead>
											...
											<td><button class="btn btn-danger btn-sm" onclick="hapus('<?php echo $key["id_acc"]; ?>')">Hapus</button>
                                            <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#mymodal" onclick="edit('<?php echo $key["id_acc"]; ?>','<?php echo $key["nama_acc"]; ?>','<?php echo $key['harga_acc'];?>','<?php echo $key['jenis'];?>')">Edit</button> 
											</tr>
										<?php $a++; } ?>
...
function hapus($id){
	...
	if (conf) {
		document.location='<?php echo base_url(); ?>ControllerAcc/hapus/'+$id;
	}
}
