...
<!-- </div> --><div class="login-logo">
    <a href="#" style="color: red;"><b>Hermon Motor</b></a>
  </div>
    <div class="login-box-body">
        <p class="login-box-msg">Sign in to Member</p>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                           <a href="<?php echo base_url()?>ControllerMember/daftar">Belum Memiliki Akun ?, Daftar Dsini.</a>
                        </label>
                    </div>
                </div>
                <!-- /.col -->
